...
class Backbone(BackboneBase):
    ...
    def __init__(self,
        ...
        if output_layers[0] == "layer1":
            num_channels = 256
        elif output_layers[0] == "layer2":
            num_channels = 512
        else:
            num_channels = 1024
...
def build_backbone(settings, backbone_pretrained=True, frozen_backbone_layers=()):
    ...
    backbone = Backbone(output_layers=['conv1'], pretrained=backbone_pretrained, frozen_layers=frozen_backbone_layers)
