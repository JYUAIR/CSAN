...
class ResNet(Backbone):
    ...
    def __init__(self, block, layers, output_layers, num_classes=1000, inplanes=64, dilation_factor=1, frozen_layers=()):
        ...
        self.conv1 = nn.Conv2d(51, inplanes, kernel_size=7, stride=2, padding=3,
                               bias=False) #51
...
def resnet50(output_layers=None, pretrained=False, **kwargs):
    ...
    checkpoint_path = "/home/hye/hyper/hyter_transt_templates/ltr/workspace/checkpoints/ltr/transt/transt/abcTransT_ep0059.pth.tar"
    checkpoint_dict = loading.torch_load_legacy(checkpoint_path)
    model_dict = model.state_dict()
    model_dict["conv1.weight"].copy_(checkpoint_dict["net"]["backbone.0.body.conv1.weight"])
