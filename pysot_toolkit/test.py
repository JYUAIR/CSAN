...
def main():
    ...
    dataset_root = '/opt/data/private/houyueen/mydata/pytracking/pytracking/ltr/dataset/VOT2019' #Absolute path of the dataset
    net_path = '/opt/data/private/houyueen/mydata/transformer_tracking_MixED_1/ltr/workspace/checkpoints/ltr/transt/transt/' #Absolute path of the model
